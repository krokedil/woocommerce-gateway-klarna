...
if ( 'NO' == $this->klarna_helper->get_klarna_country() ) { ?>
	...
	<script type="text/javascript">
		...
		jQuery(document).ready(function ($) {
			var klarna_invoice_selected_country = $("#billing_country").val();

			// If no Billing Country is set in the checkout form, use the default shop country
			if (!klarna_invoice_selected_country) {
				var klarna_invoice_selected_country = '<?php echo $this->shop_country;?>';
			}

			if (klarna_invoice_selected_country == 'SE') {
				var klarna_invoice_current_locale = 'sv_SE';
			} else if (klarna_invoice_selected_country == 'NO') {
				var klarna_invoice_current_locale = 'nb_NO';
			} else if (klarna_invoice_selected_country == 'DK') {
				var klarna_invoice_current_locale = 'da_DK';
				...
				var klarna_invoice_current_locale = 'de_AT';
			} else {
				klarna_invoice_current_locale = 'en_GB';
			}
